...
drop policy if exists "Allow anon upsert goal_milestones" on public.goal_milestones;
drop policy if exists "Allow anon update goal_milestones" on public.goal_milestones;
drop policy if exists "Allow anon select goal_comments" on public.goal_comments;
drop policy if exists "Allow anon insert goal_comments" on public.goal_comments;
...
create policy "Allow anon upsert goal_milestones"
on public.goal_milestones
for insert
to anon
with check (true);

create policy "Allow anon update goal_milestones"
on public.goal_milestones
for update
to anon
using (true)
...
create policy "Allow anon insert goal_comments"
on public.goal_comments
for insert
to anon
with check (true);
